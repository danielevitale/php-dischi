    ...
    'success': function success(data) {
      ...
      for (var i = 0; i < db_dischi.length; i++) {
        ...
        var context = {
          ...
          "anno": db_dischi[i].anno // Genero la var html e inserisco nel html
...
$(document).ready(function () {
  ...
  $("select").change(function () {
    ...
    console.log(scelto); // Verifico che l'utente abbia effettivamente scelto un artista

    if (scelto != '') {
      // Svuoto il container delle card visualizzate prima del change select
      $(".container").empty(); // Effettuo chiamata ajax per inviare l'artista scelto dall'utente
  ...
  $("button").click(function () {
    ...
    $.ajax({
      ...
      'success': function success(data) {
        ...
        var array_ordinato = JSON.parse(data); // Scorro l'array di oggetti array_ordinato e genero l'oggetto context
        ...
        for (var i = 0; i < array_ordinato.length; i++) {
          var context = {
            ...
            "anno": array_ordinato[i].anno // Genero la var html e inserisco nel html
...
__webpack_require__(/*! C:\MAMP\htdocs\esercizi\esercizio_44-php-dischi\esercizio_44_php-dischi_con_ajax\src\js\script.js */"./src/js/script.js");
module.exports = __webpack_require__(/*! C:\MAMP\htdocs\esercizi\esercizio_44-php-dischi\esercizio_44_php-dischi_con_ajax\src\style\style.scss */"./src/style/style.scss");
